...
public class OwnerMenuFragment extends Fragment {
     ...
     * @return A new instance of fragment OwnerMenuFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static OwnerMenuFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_owner_menu, container, false);
                ...
                if (restaurantDTOList != null){
                    RestaurantAdapter restaurantAdapter = new RestaurantAdapter(restaurantDTOList
                        ...
                        public void onItemClick(RestaurantDTO item) {
                            try {
                                Intent intent = new Intent(getActivity(), OwnerMenuDetailActivity.class);
